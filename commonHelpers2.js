import"./assets/sign-in-eed5bcf9.js";import"./assets/vendor-63749fbb.js";const n=JSON.parse(localStorage.getItem("bookList"))||[],p=document.querySelector(".shopping-list");function r(t,s){const e=n.slice(t,s),o=`<svg class="trash-delete" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
