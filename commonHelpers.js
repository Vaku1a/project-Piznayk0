import{g as f,r as t,a as E,s as m,b as C,c as B,d as T}from"./assets/sign-in-69d2672c.js";import"./assets/vendor-4a003f61.js";async function g(o){const e=await localStorage.getItem(o);return await JSON.parse(e)}async function v(o,e){try{await localStorage.setItem(o,JSON.stringify(e))}catch(a){console.log(a.message)}}f().then(o=>{if(t.loaderForAllCategories.style.display="block",o.length===0){t.booksPart.insertAdjacentHTML("afterbegin",`${d}`);return}t.booksPart.insertAdjacentHTML("beforeend",`<h2 class="books-part-title">Best Sellers
