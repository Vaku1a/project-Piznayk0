import{g as d,r as A,a as u,b,c as f}from"./assets/sign-in-3895db2b.js";import"./assets/vendor-c1cf73b3.js";d().then(e=>{if(!e||e.length===0){A.booksPart.insertAdjacentHTML("afterbegin",`<div class="books-not-found-wrapper">
            ...
            <div class="book-category-wrapper">
                ...
                <button type="button" class="see-more-btn">See more</button>             
                    ...
                    <div class="book-categories-container">
                    ${I(t)}
                    </div>`}).catch(t=>{console.error(t)});return}u(s).then(t=>{if(t.length===0){A.booksPart.innerHTML=`${r(s)}
                    <div class="book-category-wrapper">
                    <div class="books-not-found-wrapper">
                    <p class="books-not-found-message">No books were found in this category😒<br> Please, try other categories😉</p>
                    <img
