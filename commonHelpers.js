import{g as h,r as e,e as r,a as p,b as E,c as B,d as L}from"./assets/sign-in-ebfc0d37.js";import"./assets/vendor-c1cf73b3.js";h().then(o=>{if(o.length===0){e.booksPart.insertAdjacentHTML("afterbegin",`<div class="books-not-found-wrapper">
            ...
            </div>`).join("")}B().then(o=>{e.categoriesList.innerHTML=S(o)}).catch(o=>{console.error(o)});e.categoriesList.addEventListener("click",T);function T(o){if(o.target.nodeName!=="LI")return;const t=o.target;if(t.classList.contains("active")){console.log("Repeat click on acrive category - No GET request - Just return");return}window.scrollTo(0,0),t.parentElement.querySelector(".categories-list-item.active").classList.remove("active"),t.classList.add("active");const a=o.target.dataset.categoryName;if(a==="All categories"){h().then(s=>{if(s.length===0){e.booksPart.innerHTML=`<h2 class="books-part-title">Best Sellers
                        <span class="books-part-title-span"> Books</span>
                        </h2>
                        <div class="book-categories-container">
                        <div class="books-not-found-wrapper">
