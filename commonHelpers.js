import{g as E,r as e,a as h,e as A,b as v,c as B,d as C}from"./assets/sign-in-1fd13543.js";import"./assets/vendor-c1cf73b3.js";E().then(t=>{if(t.length===0){e.booksPart.insertAdjacentHTML("afterbegin",`${c}`);return}e.booksPart.insertAdjacentHTML("beforeend",`<h2 class="books-part-title">Best Sellers
...
/>
            ...
            `}async function m(){try{const t=await g(l).then(o=>o||[]).catch(o=>{console.log(o.message)});t.push(i),L(l,t),u(i)}catch(t){console.log(t.message)}}async function b(){try{const o=(await g(l)).filter(s=>s._id!==i._id);L(l,o),u(i)}catch(t){console.log(t.message)}}window.onscroll=()=>{j()};function j(){document.body.scrollTop>20||document.documentElement.scrollTop>20?document.getElementById("back-to-up").classList.remove("is-hidden"):document.getElementById("back-to-up").classList.add("is-hidden")}(()=>{function t(){window.scrollTo({top:0,behavior:"smooth"})}document.querySelector("#back-to-up").addEventListener("click",t)})();
