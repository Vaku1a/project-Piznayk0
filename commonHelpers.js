import{g as f,r as e,a as y,b as L,c as T}from"./assets/sign-in-3895db2b.js";import"./assets/vendor-c1cf73b3.js";const r="/project-Piznayk0/assets/empty-bin@1x-a278a77f.png",p="/project-Piznayk0/assets/empty-bin@2x-1268a808.png";f().then(o=>{if(o.length===0){e.booksPart.insertAdjacentHTML("afterbegin",`<div class="books-not-found-wrapper">
        ...
        </li>`).join("")}const c="bookList";let i={};e.booksPart.addEventListener("click",x);e.popupEl.firstElementChild.addEventListener("click",B);e.popupEl.parentNode.addEventListener("click",v);document.addEventListener("keydown",v);function v(o){(o.target===o.currentTarget||o.key==="Escape")&&(e.popupEl.parentNode.classList.toggle("is-hidden"),e.body.classList.toggle("popup-modal-open"))}function B(o){o.target.closest(".popup-btn-close")===e.popupEl.firstElementChild&&(e.popupEl.parentNode.classList.toggle("is-hidden"),e.body.classList.toggle("popup-modal-open"))}function x(o){if(o.target===o.currentTarget)return;o.preventDefault(),e.popupEl.parentNode.classList.toggle("is-hidden"),e.body.classList.toggle("popup-modal-open");const t=o.target.closest("LI").dataset.bookId||o.target.parentNode.dataset.bookId;T(t).then(a=>{i=a,k(i);let s=P(i);N(s)})}async function u(o){const t=await localStorage.getItem(o);return await JSON.parse(t)}async function $(o,t){try{await localStorage.setItem(o,JSON.stringify(t))}catch(a){console.log(a.message)}}async function k(o){try{(await u(c).then(s=>s||[]).catch(s=>{console.log(s.message)})).some(({_id:s})=>s===o._id)?(e.popupEl.lastElementChild.previousElementSibling.removeEventListener("click",b),e.popupEl.lastElementChild.previousElementSibling.addEventListener("click",h),e.popupEl.lastElementChild.previousElementSibling.textContent="remove from the shopping list",e.popupEl.lastElementChild.hidden=!1):(e.popupEl.lastElementChild.previousElementSibling.removeEventListener("click",h),e.popupEl.lastElementChild.previousElementSibling.addEventListener("click",b),e.popupEl.lastElementChild.previousElementSibling.textContent="Add to shopping list",e.popupEl.lastElementChild.hidden=!0)}catch(t){console.log(t.message)}}function N(o){e.popupEl.firstElementChild.nextElementSibling.innerHTML=o}function P({book_image:o,title:t,author:a,description:s,buy_links:[n,l]}){return`<img src="${o}" class="popup-image" />
            <div class ="info-book">
